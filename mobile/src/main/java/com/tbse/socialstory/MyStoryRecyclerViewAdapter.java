...
import com.tbse.socialstory.dummy.DummyContent.DummyItem;
import com.tbse.socialstory.fragments.StoryFragment.OnListFragmentInteractionListener;
...
public class MyStoryRecyclerViewAdapter extends RecyclerView.Adapter<MyStoryRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.story_id);
            mContentView = (TextView) view.findViewById(R.id.story_content);
        }
